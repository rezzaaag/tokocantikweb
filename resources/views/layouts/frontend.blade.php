                    ...
                    <div class="container-fluid">
                        <div class="header-bottom-wrapper">
                            <div class="logo-2 furniture-logo ptb-30">
                                <a href="/">
                                    <img height="60" style="transform:scale(2s);object-fit: cover;" src="{{ asset('frontend/assets/img/logo/logo.png') }}" alt="">
                                </a>
                            </div>
                    ...
                    <div class="widget-wrapper">
                        ...
                        <img height="60" style="transform:scale(1.5);object-fit: cover;" src="{{ asset('frontend/assets/img/logo/logo.png') }}" alt="">
                            <div class="footer-about-2">
                                <p>Situs Kosmetik Terlengkap & Terpercaya #1 di Indonesia </p>
                            </div>
                        </div>
                        <div class="footer-widget mb-30">
                            ...
                            <div class="footer-info-wrapper-3">
                                <div class="footer-address-furniture">
                                    ...
                                    <div class="footer-info-content3">
                                        <p>Komp. Buah Batu Regency A2 No.9 - 10 Kel. Kujangsari <br>
                                        / Cijawura Kec. Bandung Kidul, Bandung, Jawa Barat, <br>
                                        Indonesia. </p>
                                    </div>
                                </div>
                                <div class="footer-address-furniture">
                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            <div class="copyright-furniture">
                                <p>Copyright © <a href="https://hastech.company/">Rezza</a> 2022 . All Right Reserved.</p>
                            </div>
                        </div>
                    </div>
                </div>
