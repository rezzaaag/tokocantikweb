...
class OrderController extends Controller
{
	...
	public function checkout(Request $request){
		...
		try{
			...
			$order->save();
			$this->completekansaja($order);

			return redirect('payments/completed?order_id='. $order->code);
		}
		catch(Exception $e) {
			echo $e->getMessage();
		}
	...
	public function completekansaja($order){
		$paymentParams = [
			'order_id' => $order->id,
			...
			'token' => Str::random(12),
			'payloads' => json_encode(['message'=>'ok']),
			'payment_type' => 'hardcode',
			'va_number' => '123124123124123123',
			'vendor_name' => 'Bank Mandiri',
			'biller_code' => '123124145314123',
			'bill_key' => '12312412312412312',
		];
